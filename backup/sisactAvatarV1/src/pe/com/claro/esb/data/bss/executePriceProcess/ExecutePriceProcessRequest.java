/**
 * ExecutePriceProcessRequest.java
 *
...
public class ExecutePriceProcessRequest  implements java.io.Serializable {
    ...
    public ExecutePriceProcessRequest() {
    }
    ...
    /**
     * Gets the user value for this ExecutePriceProcessRequest.
     * 
     * @return user
     */
    ...
    /**
     * Sets the user value for this ExecutePriceProcessRequest.
     * 
     * @param user
     */
    ...
    /**
     * Gets the password value for this ExecutePriceProcessRequest.
     * 
     * @return password
     */
    ...
    /**
     * Sets the password value for this ExecutePriceProcessRequest.
     * 
     * @param password
     */
    ...
    /**
     * Gets the listaRequestOpcional value for this ExecutePriceProcessRequest.
     * 
    ...
    /**
     * Sets the listaRequestOpcional value for this ExecutePriceProcessRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExecutePriceProcessRequest)) return false;
        ExecutePriceProcessRequest other = (ExecutePriceProcessRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExecutePriceProcessRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://claro.com.pe/esb/data/bss/executePriceProcess", "executePriceProcessRequest"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("user");
        elemField.setXmlName(new javax.xml.namespace.QName("http://claro.com.pe/esb/data/bss/executePriceProcess", "user"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("password");
        elemField.setXmlName(new javax.xml.namespace.QName("http://claro.com.pe/esb/data/bss/executePriceProcess", "password"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("listaRequestOpcional");
        elemField.setXmlName(new javax.xml.namespace.QName("http://claro.com.pe/esb/data/bss/executePriceProcess", "listaRequestOpcional"));
