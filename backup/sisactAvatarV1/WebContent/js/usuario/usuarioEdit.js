...
function load(){
	...
	if(btnUpdate.obj){
		...
		btnUpdate.obj.action="usuario.htm";
	...
	if(btnGuardar.obj){
		...
		btnGuardar.obj.action="usuario.htm";
	...
	if(btnCancelar.obj){
		...
		btnCancelar.obj.action="usuario.htm";
	...
	var a_fields = {
	"username" : {'l':'Login','r':true,'f': 'alphanum'}
 	},
 	c_fields = {
	...
	var v = new validator('formUsuarioEdit', a_fields, o_config);
	var v1 = new validator('formUsuarioEdit', d_fields, o_config);
	var v5 = new validator('formUsuarioEdit', c_fields, o_config);
