...
function load(){
	...
	if(btnUpdate.obj){
		...
		btnUpdate.obj.action="opcion.htm";
		btnUpdate.obj.metodo="doUpdate";
		btnUpdate.obj.msg='Se ha solicitado actualizar el opcion,\n desea continuar?';
	}
	...
	if(btnGuardar.obj){
		...
		btnGuardar.obj.action="opcion.htm";
		btnGuardar.obj.metodo="doSave";
		btnGuardar.obj.msg='Se ha solicitado guardar un opcion,\n desea continuar?';
	...
	if(btnCancelar.obj){
		...
		btnCancelar.obj.action="opcion.htm";
	...
	var a_fields = {
	"nombre" : {'l':'Nombre','r':true,'f': 'alphanum'}
 	},
 	c_fields = {
	...
	var v = new validator('formOpcionEdit', a_fields, o_config);
	var v1 = new validator('formOpcionEdit', d_fields, o_config);
	var v5 = new validator('formOpcionEdit', c_fields, o_config);
