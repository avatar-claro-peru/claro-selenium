...
function load(){
	...
	if(btnUpdate.obj){
		...
		btnUpdate.obj.action="topeConsumo.htm";
		btnUpdate.obj.metodo="doUpdate";
		btnUpdate.obj.msg='Se ha solicitado actualizar los datos del tope de consumo,\n desea continuar?';
	...
	if(btnGuardar.obj){
		...
		btnGuardar.obj.action="topeConsumo.htm";
		btnGuardar.obj.metodo="doSave";
		btnGuardar.obj.msg='Se ha solicitado guardar los datos del tope de consumo.\n ¿Desea continuar?';
	...
	if(btnCancelar.obj){
		...
		btnCancelar.obj.action="topeConsumo.htm";
...
*/
	...
	var v = new validator('formTopeConsumoEdit', a_fields, o_config);
	var v1 = new validator('formTopeConsumoEdit', d_fields, o_config);
