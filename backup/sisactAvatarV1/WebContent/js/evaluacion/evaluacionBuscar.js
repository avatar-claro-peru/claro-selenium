...
function load(){
	...
	if(btnSearch.obj){
		...
		btnSearch.obj.action="evaluacion.htm";
	...
	function doEdit(id){
		...
		if(objForm.id.value != ''){
			...
			objForm.action = "evaluacion.htm";
			objForm.submit();
		} 
		else{
			alert("Debe seleccionar una evaluacion");
		}
	...
	var a_fields = {'ordenId' : {'l': 'ordenId','r': false,'f': 'intPos'}
				}
		o_config = {'alert' : 1	}

	// validator constructor call
	var v = new validator('formEvaluacionBuscar', a_fields, o_config);
